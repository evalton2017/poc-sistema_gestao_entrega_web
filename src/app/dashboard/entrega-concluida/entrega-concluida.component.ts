...
@Component({
  selector: 'app-entrega-concluida',
  templateUrl: './entrega-concluida.component.html',
  styleUrls: ['./entrega-concluida.component.scss']
})
export class EntregaConcluidaComponent implements OnInit, AfterViewInit  {


  displayedColumns: string[] = ['transportadora', 'pedido', 'dataSaida', 'dataEntrega','estado'];
  ...
  exibirGraficoConcluida(){
    ...
    chart.draw(this.obterDataTable(this.dadosEntrega.concluidas), this.obterOpcoes("Entregas Concluídas"));
  }
